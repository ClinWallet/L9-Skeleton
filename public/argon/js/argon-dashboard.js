    ...
    sidenavToggler.onclick = function() {
      if (!sidenavShow.classList.contains('g-sidenav-hidden')) {
        ...
        // START
          ...
          if (navbarBrandImg.includes('CW_logo_min.png')) {
              var navbarBrandImgNew = navbarBrandImg.replace("_min", "_max");
              navbarBrand.src = navbarBrandImgNew;
            } else {
              var navbarBrandImgNew = navbarBrandImg.replace("_max", "_min");
              navbarBrand.src = navbarBrandImgNew;
            }
        // END
